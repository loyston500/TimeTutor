...
extension SubjectQueryFilter
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> hashCodeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> hashCodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
